...
function ServicesPage() {
    const services = [
        ...
        },
        {
            ...
            description: 'Мы поможем Вам подать документы на оформление загранпаспортов для граждан России: взрослым, детям, срочно и не очень, биометрический на 10 лет или стандартный на 5 лет, а также иногородним гражданам и гражданам без регистрации и прописки.',
            price: 'от 12 000 ₽'
        },
        {
            id: 'apostil',
